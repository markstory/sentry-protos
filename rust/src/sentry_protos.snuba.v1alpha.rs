...
pub struct NumberFilter {
    ...
    #[prost(enumeration = "number_filter::Op", tag = "2")]
    pub op: i32,
    #[prost(float, tag = "3")]
    pub value: f32,
}
/// Nested message and enum types in `NumberFilter`.
...
pub mod trace_item_filter {
    ...
    pub enum Value {
        ...
        #[prost(message, tag = "3")]
        NumberFilter(super::NumberFilter),
        #[prost(message, tag = "4")]
...
pub struct SpanSamplesRequest {
    ...
    pub requested_attributes: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    #[prost(uint32, tag = "5")]
    pub limit: u32,
    /// required if you want project.name "virtual column" to exist
    #[prost(map = "string, uint64", tag = "6")]
    pub project_names_to_ids: ::std::collections::HashMap<
...
/// Nested message and enum types in `SpanSample`.
pub mod span_sample {
    #[allow(clippy::derive_partial_eq_without_eq)]
    #[derive(Clone, PartialEq, ::prost::Message)]
    pub struct Data {
        #[prost(oneof = "data::Value", tags = "1, 2")]
